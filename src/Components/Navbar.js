...
export function Navbar(){
    ...
    var [user, setUser] = useState({name:"Ashu", id:12345 , role:"Trainer" , experience:"Kuch nahi" , salary:"chindi"})

    useEffect(()=>{
      // when component is mounted i asked to make an api call
      // api call returned me some data 
      // i assigned that data to name property of state 
    })
